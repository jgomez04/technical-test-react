    ...
    <>
      ...
      <div className='h-screen mt-1'>
        <div className="relative p-6 rounded-lg h-[700px] half-bg pl-[100px]">
          ...
          <div className="absolute top-[100px] right-20 z-10">
            <img src={Grupo5} alt="icon" className='h-[500px] w-[500px]'/>
          </div>

          <div className='absolute bottom-0 right-0 rounded-tl-[90px] rounded-bl-[90px] bg-[#f6dcdc] text-white p-4 h-[178px] w-[778px] z-0'>
          </div>
        </div>
      </div>
